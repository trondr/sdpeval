...
module internal BaseApplicabilityRules =    
    ...
    type MsiProductInstalled = {ProductCode:string;VersionMin:string option;ExcludeVersionMin:string option;VersionMax:string option;ExcludeVersionMax:string option;Languange:string option}
